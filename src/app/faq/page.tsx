      ...
      <section className="container-msm py-12 md:py-16">
        ...
        <div className="max-w-3xl mx-auto mt-12 text-center space-y-5">
          ...
          <p className="text-[rgb(var(--text-muted))] leading-relaxed">
            Fale com a engenharia da Somatec Blocking: as cinco primeiras etapas não têm custo e você
            só paga se o resultado for comprovado.
          </p>
          <CommercialCta
            label="Falar com a engenharia"
            mensagem="Olá! Vim pelo site, li as perguntas frequentes e fiquei com uma dúvida sobre proteção."
