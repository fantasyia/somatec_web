...
export const MASTER_BLOCK_MODELS: readonly MasterBlockModel[] = [
  { model: 'MB-01', loadLabel: '1 – 125 A', loadMax: 125, surge: '8 kA', nominal: '3 kA', dim: '150 × 100 × 60', weight: '1,4' },
  { model: 'MB-02', loadLabel: '125 – 250 A', loadMax: 250, surge: '16 kA', nominal: '6 kA', dim: '150 × 100 × 60', weight: '1,6' },
  { model: 'MB-03', loadLabel: '250 – 400 A', loadMax: 400, surge: '24 kA', nominal: '9 kA', dim: '200 × 100 × 70', weight: '1,8' },
  { model: 'MB-04', loadLabel: '400 – 500 A', loadMax: 500, surge: '32 kA', nominal: '12 kA', dim: '200 × 100 × 70', weight: '2,0' },
  { model: 'MB-05', loadLabel: '500 – 630 A', loadMax: 630, surge: '40 kA', nominal: '15 kA', dim: '200 × 150 × 90', weight: '3,4' },
  { model: 'MB-06', loadLabel: '630 – 800 A', loadMax: 800, surge: '48 kA', nominal: '18 kA', dim: '200 × 150 × 90', weight: '3,7' },
  { model: 'MB-07', loadLabel: '800 – 1000 A', loadMax: 1000, surge: '56 kA', nominal: '21 kA', dim: '250 × 200 × 100', weight: '5,2' },
  { model: 'MB-08', loadLabel: '1000 – 1250 A', loadMax: 1250, surge: '64 kA', nominal: '24 kA', dim: '250 × 200 × 100', weight: '5,5' },
  { model: 'MB-09', loadLabel: '1250 – 1600 A', loadMax: 1600, surge: '72 kA', nominal: '27 kA', dim: '280 × 220 × 100', weight: '8,2' },
  { model: 'MB-10', loadLabel: '1600 – 2500 A', loadMax: 2500, surge: '80 kA', nominal: '30 kA', dim: '280 × 220 × 100', weight: '8,5' },
  { model: 'MB-11', loadLabel: '2500 – 3200 A', loadMax: 3200, surge: '88 kA', nominal: '33 kA', dim: '350 × 260 × 120', weight: '13,5' },
  { model: 'MB-12', loadLabel: '3200 – 6300 A', loadMax: 6300, surge: '100 kA', nominal: '37 kA', dim: '350 × 260 × 120', weight: '14,0' },
] as const;
